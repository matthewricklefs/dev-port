        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <p>
              ...
              real-world problems utilizing technology at the intersection of
              design and code.
            </p>
          </div>
  ...
  data() {
    return {
      ...
      icons: {
        ...
        front: require("../assets/images/icon02.svg"),
        back: require("../assets/images/icon03.svg"),
        ux: require("../assets/images/icon04.svg"),
      },
    };
  },
